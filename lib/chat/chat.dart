...
class ChatScreenState extends State<ChatScreen> {
 ...
 //id =  "cpzK6drapIUuz9gEWWZO" ;//eman
   // id='OFM0P9iJqHwLeaiIztWy' ;//osman
  // id= "VaMkkscXUbfrsfIQAdZ4cvmok4z1";//ahmed2
  //  id="81nwUL3cKAeEd6JbJlzViFarXhr1";//ahmed3

    id=auth.userData.DocumentID;
   // print("id id $id");
...
/////////////////////////note note note note////////////////////////////////////////////////
  ...
  Future<bool> onBackPress() {
    if (isShowSticker) {
      ...
      Firestore.instance.collection('User').document(id).updateData({'chattingWith': null});
